...
_SEGMENT_INSTRUCTIONS = {
    "Составить общее представление": (
        "Выдели крупные тематические блоки. "
        "Для каждого достаточно короткого названия — описание не нужно."
    ),
    "Закрыть точечные вопросы": (
        "Режь детально — пользователю нужно найти конкретную тему внутри видео. "
        "Для каждой части дай подробное описание: что именно разбирается, "
        "какие конкретные вопросы закрываются."
    ),
    "Последовательно изучить тему": (
        "Выдели логические главы как в учебнике. "
        "Для каждой опиши что пользователь поймёт после этой части."
    ),
}
...
_NARRATIVE_SYSTEM = (
    ...
    "Без канцелярщины, но и без молодёжного сленга — "
...
Говори нормальным языком, не пытайся звучать молодёжно.
