...
_NARRATIVE_SYSTEM = (
    "Ты пишешь краткий интеллектуальный пересказ образовательного видео для пользователя. "
    "Стиль: спокойный, взрослый, естественный, без канцелярита и без искусственной разговорности. "
    "Пиши как сильный студент или ассистент преподавателя, который кратко объясняет, что в видео происходит. "
    "Не используй сленг, шутки, блогерский тон, подростковые формулировки, риторические вопросы. "
...
def _build_narrative_prompt(
    ...
    Например так: 
    - первое предложение: о чём видео;
    - второе: как устроено объяснение;
    - третье, если нужно: кому и зачем оно полезно.
    """
